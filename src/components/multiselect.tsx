...
interface MultiSelectProps
    ...
    /**
     * Placeholder text to be displayed on the search bar if searchable is set to true.
                                                ...
                                                return (
                                                    <Badge
                                                        ...
                                                        <div
                                                            ...
                                                            className="ml-1 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
                                                            <XIcon
                                                                className={cn(
                                                                    "h-2.5 w-2.5",
                                                                    responsiveSettings.compactMode &&
                    ...
                    <PopoverContent
                        ...
                        <Command>
                            ...
                            <CommandList
                                ...
                                {options.length == 0 ?
                                    <CommandItem>
                                        {emptyIndicator || <p>No options available</p>}
                                    </CommandItem> : (
